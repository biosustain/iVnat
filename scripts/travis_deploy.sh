...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "biosustain/iVnat" ]]; then
...
echo "Your new report will be visible at https://biosustain.github.io/iVnat in a moment."
